    ...
    <div>
      <div className="mx-auto overflow-hidden" style={{ maxWidth: "100%" }}>
        <div
          ...
          style={{
            aspectRatio: "3/5",
            padding: "3px",
            background: `linear-gradient(145deg, #A63A3A, #B84A4A, #A63A3A, #8C2D2A, #A63A3A)`,
          }}
        >
          <div
      ...
      <div className="flex justify-center mt-4">
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded bg-gradient-to-r from-accent to-accent2 text-white font-[family-name:var(--font-body)] text-sm font-semibold cursor-pointer transition-all duration-300 hover:shadow-[0_0_20px_rgba(140,45,42,0.2)] hover:-translate-y-0.5"
        >
          Save Image
        </button>
      </div>
