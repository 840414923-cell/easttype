    ...
    case 0:
      return (
        <div className="h-full flex flex-col items-center justify-center text-center px-2">
          <div className="text-[10px] uppercase tracking-[0.3em] text-[#A63A3A] mb-4">Personalized Report</div>
          <div className="w-12 h-px bg-[#A63A3A] mb-4" />
    ...
    case 1:
      return (
        <div className="space-y-3">
          ...
          <div>
            <div className="text-[10px] font-bold text-[#A63A3A] uppercase tracking-wider mb-1.5">Your Natural Strengths</div>
            <ul className="space-y-1">
              {[
                ...
                <li key={x} className="text-[10px] text-[#444] leading-[1.5] flex gap-1.5">
                  <span className="text-[#A63A3A] shrink-0">&#9670;</span>
                  <span>{x}</span>
                </li>
              ))}
            </ul>
            ...
            {[
              ...
              <div key={row.f} className="border border-[#e0d8cc] rounded p-2 bg-[#fcfaf7]">
                <div className="flex items-center justify-between mb-0.5">
                  ...
                  <span className="text-[9px] text-[#A63A3A] font-medium">{row.a}</span>
                </div>
    ...
    case 3:
      return (
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={row.t} className="flex items-start gap-2.5 pb-2 border-b border-[#f0ebe3]">
                <div className="shrink-0 w-[60px] bg-[rgba(140,45,42,0.08)] rounded px-1.5 py-0.5 text-center">
                  <div className="text-[9px] font-bold text-[#A63A3A]">{row.t}</div>
                </div>
          ...
          <div className="p-2.5 rounded bg-[rgba(140,45,42,0.06)] border border-[rgba(140,45,42,0.12)]">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <ol className="space-y-1.5 text-[10px] text-[#444] leading-[1.6]">
              <li className="flex gap-2"><span className="text-[#A63A3A] font-bold shrink-0">1.</span><span>Rinse rice under cold water 2-3 times until water runs clear. Drain.</span></li>
              <li className="flex gap-2"><span className="text-[#A63A3A] font-bold shrink-0">2.</span><span>Peel Chinese yam, cut into 2cm cubes. Wear gloves: the sap can irritate skin.</span></li>
              <li className="flex gap-2"><span className="text-[#A63A3A] font-bold shrink-0">3.</span><span>Place rice in pot with 1200ml water and ginger. Bring to rolling boil.</span></li>
              <li className="flex gap-2"><span className="text-[#A63A3A] font-bold shrink-0">4.</span><span>Reduce heat to low. Simmer 30 minutes, stirring every 5 minutes.</span></li>
              <li className="flex gap-2"><span className="text-[#A63A3A] font-bold shrink-0">5.</span><span>Add yam cubes and red dates. Simmer 20 more minutes until creamy.</span></li>
              <li className="flex gap-2"><span className="text-[#A63A3A] font-bold shrink-0">6.</span><span>Add goji berries, stir gently. Cook 2 more minutes. Do not overcook.</span></li>
              <li className="flex gap-2"><span className="text-[#A63A3A] font-bold shrink-0">7.</span><span>Remove ginger. Serve warm. Reheats beautifully with a splash of water.</span></li>
            </ol>
          </div>
          <div className="p-2 rounded bg-[rgba(140,45,42,0.06)] border border-[rgba(140,45,42,0.12)]">
      ...
      return (
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="px-2 py-0.5 rounded bg-[rgba(140,45,42,0.1)] text-[8px] font-bold text-[#A63A3A] uppercase tracking-wider">Full Report</span>
          </div>
          <div className="space-y-2">
            {[
              ...
              <div key={x.n} className="border border-[#e0d8cc] rounded p-2 bg-[#fcfaf7]">
                ...
                <div className="text-[9px] text-[#A63A3A] mt-0.5"><span className="font-medium">Location: </span><span dangerouslySetInnerHTML={{ __html: x.loc }} /></div>
    ...
    case 7:
      return (
        <div className="space-y-3">
          ...
          <div>
            <div className="text-[10px] font-bold text-[#A63A3A] uppercase tracking-wider mb-1.5">Daily Non-Negotiables</div>
    ...
    return (
      ...
      >
        <div className="bg-[#f8f6f2] px-3 py-1.5 border-b border-[#e0d8cc] flex items-center justify-between shrink-0">
          <span className="text-[8px] font-bold text-[#A63A3A] uppercase tracking-wider">EastType</span>
          <span className="text-[7px] text-[#bbb]">{section}</span>
        </div>
        <div className="flex-1 px-3 py-2 overflow-hidden">{children}</div>
        <div className="bg-[#f8f6f2] px-3 py-0.5 text-center text-[6px] text-[#A63A3A] font-semibold tracking-wider border-t border-[#e0d8cc] shrink-0">
  ...
  return (
    ...
    >
      <div className="bg-[#f8f6f2] px-5 py-3 border-b border-[#e0d8cc] flex items-center justify-between shrink-0">
        <span className="text-xs font-bold text-[#A63A3A] uppercase tracking-wider">EastType</span>
        <span className="text-[10px] text-[#bbb]">{section}</span>
      </div>
      <div className="flex-1 px-5 py-4 overflow-y-auto overscroll-contain">
        {children}
      </div>
      <div className="bg-[#f8f6f2] px-5 py-2 text-center text-[9px] text-[#A63A3A] font-semibold tracking-wider border-t border-[#e0d8cc] shrink-0">
        www.myeasterntype.com
      </div>
    </div>
  )
