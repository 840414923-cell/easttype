  ...
  return (
    <div className="mb-3">
      <button
        ...
        className="w-full text-left px-4 py-2.5 rounded bg-[rgba(140,45,42,0.05)] border border-[rgba(140,45,42,0.12)] cursor-pointer transition-colors hover:border-[rgba(140,45,42,0.25)] flex items-center justify-between gap-2"
      >
      ...
      {open && (
        <div className="px-4 py-3 mt-1.5 rounded bg-[rgba(140,45,42,0.03)] border border-[rgba(140,45,42,0.08)]">
          {children}
        </div>
      )}
    </div>
        ...
        <div className="flex items-center gap-4 mb-6 mt-5">
          ...
          <div className="flex-1 h-[3px] bg-border rounded overflow-hidden">
            <div
              ...
              style={{
                width: `${progress}%`,
                background: "linear-gradient(90deg, #A63A3A, #B84A4A)",
              }}
            />
          </div>
    ...
    <div className="max-w-lg mx-auto px-6 py-6 sm:py-12 min-h-screen flex flex-col items-center justify-center">
      ...
      <div className={`mt-5 w-full max-w-md transition-all duration-700 delay-600 ${animated ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
        <button
          ...
          className="w-full py-5 rounded-2xl font-[family-name:var(--font-body)] text-lg font-bold cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_60px_rgba(140,45,42,0.4)] shadow-[0_0_30px_rgba(140,45,42,0.15)] border-2 border-[rgba(255,255,255,0.15)]"
