  ...
  return (
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        {/* Hero Section */}
        <section className="relative overflow-hidden rounded-3xl mb-16 bg-gradient-to-br from-[rgba(140,45,42,0.08)] via-[rgba(140,45,42,0.04)] to-transparent border border-[rgba(140,45,42,0.2)]">
          <div className="absolute top-0 right-0 w-72 h-72 bg-[rgba(140,45,42,0.06)] rounded-full blur-3xl -translate-y-1/3 translate-x-1/3 pointer-events-none" />
          <div className="relative px-8 py-14 sm:px-14 sm:py-16">
            <div className="grid lg:grid-cols-[1fr_320px] gap-10 items-center">
              <div>
                <div className="inline-block px-3 py-1 rounded-full bg-[rgba(140,45,42,0.12)] text-accent text-xs font-medium uppercase tracking-wider mb-5">
                  Symptom Library
                </div>
                ...
                <div className="flex flex-wrap gap-8">
                  ...
                  <div className="w-px bg-[rgba(140,45,42,0.15)]" />
                  <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {featured.map((s) => (
              <Link
                ...
                className="group block no-underline rounded-2xl overflow-hidden border border-[rgba(140,45,42,0.2)] bg-card-bg hover:border-[rgba(140,45,42,0.4)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(140,45,42,0.08)]"
              >
                ...
                <div className="p-5">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-[10px] text-accent/80 uppercase tracking-wider font-medium px-2 py-0.5 rounded-full bg-[rgba(140,45,42,0.08)]">{s.tag}</span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            {categoryCounts.map((c) => (
              <a
                key={c.anchor}
                href="#all-symptoms"
                className="group flex flex-col items-center text-center p-5 rounded-2xl border border-[rgba(140,45,42,0.2)] bg-card-bg hover:border-[rgba(140,45,42,0.4)] hover:bg-[rgba(140,45,42,0.03)] transition-all duration-300 no-underline"
              >
                <div className="w-12 h-12 rounded-full bg-[rgba(140,45,42,0.08)] flex items-center justify-center mb-3 group-hover:bg-[rgba(140,45,42,0.15)] transition-colors">
