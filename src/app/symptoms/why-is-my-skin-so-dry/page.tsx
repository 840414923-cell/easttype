...
const TITLE = "Dry Skin That Lotion Won't Fix? Your Body Type Is Running Low on Moisture"
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: TITLE,
    description: "Lotion every day and still dry? Your body type may explain it.",
    url: URL,
    type: "article",
    siteName: "EastType",
  },
