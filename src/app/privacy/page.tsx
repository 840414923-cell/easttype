          ...
          <section>
            ...
            <p className="mt-3">
              {l(
                ...
                "要行使以上任何權利，請發送電子郵件至 840414923@qq.com。我們將在30天內回覆。",
                "これらの権利を行使するには、840414923@qq.com にメールしてください。30日以内に対応いたします。"
              )}
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              {l(
                ...
                "EastType 不適用於16歲以下的個人。如果我們得知已收集16歲以下兒童的個人資料，我們將立即刪除。如果你是家長或監護人，並認為你的孩子使用了我們的服務，請聯繫 840414923@qq.com。",
                "EastTypeは16歳未満の方の使用を想定していません。16歳未満の子供の個人データを収集したことが判明した場合、速やかに削除します。お子様が本サービスを使用したと思われる場合は、840414923@qq.com までご連絡ください。"
              )}
            </p>
          </section>
          ...
          <section className="bg-cream border border-border rounded-xl p-6 text-sm">
            ...
            <p>
              {l(
                ...
                "如果你對本隱私權政策有任何疑問，或希望行使資料保護權利，請發送電子郵件至 840414923@qq.com。",
                "このプライバシーポリシーについてご質問がある場合、またはデータ保護権利を行使したい場合は、840414923@qq.com までメールでお問い合わせください。"
              )}
            </p>
          </section>
        </div>
