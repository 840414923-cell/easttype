          ...
          <button
            ...
            className={`px-4 py-1.5 rounded-full text-xs font-semibold tracking-wide transition-all no-underline ${
              filter === cat
                ...
                : "bg-card-bg text-text2 border border-[rgba(140,45,42,0.1)] hover:border-[rgba(140,45,42,0.3)]"
            }`}
          >
        ...
        {filtered.map((herb) => {
          ...
          return (
            <Link
              ...
              className="group block rounded-2xl overflow-hidden bg-card-bg border-2 border-[rgba(140,45,42,0.12)] hover:border-[rgba(140,45,42,0.4)] hover:shadow-[0_8px_30px_rgba(140,45,42,0.12)] transition-all duration-300 no-underline"
            >
              {herb.image ? (
              ...
              <div className="p-8">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  {herb.actions.slice(0, 3).map((action, i) => (
                    <span key={i} className="text-[10px] text-text2/60 bg-[rgba(140,45,42,0.05)] border border-[rgba(140,45,42,0.08)] px-2.5 py-1 rounded-md">
