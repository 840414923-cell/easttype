    ...
    <>
      ...
      <main className="flex-1">
        <article className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden bg-card-bg border border-[rgba(168,135,64,0.12)] mb-12">
            <Image
          ...
          <div className="overflow-x-auto mb-12">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b-2 border-[rgba(168,135,64,0.2)]">
              ...
              <tbody>
                {solution.formulas.map((f) => (
                  <tr key={f.slug} className="border-b border-[rgba(168,135,64,0.08)]">
          ...
          <div className="space-y-6 mb-12">
            {solution.bodyTypeExplanations.map((bt, i) => (
              <div key={i} className="rounded-xl border border-[rgba(168,135,64,0.12)] bg-card-bg p-6">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {bt.symptoms.map((s, j) => (
                      <span key={j} className="text-xs text-text2/70 bg-[rgba(168,135,64,0.05)] border border-[rgba(168,135,64,0.1)] px-2.5 py-1 rounded-md">
                        {s}
                      </span>
                    ))}
                  </div>
                </div>
                <div className="bg-[rgba(168,135,64,0.04)] rounded-lg p-3">
          ...
          {solution.formulas.map((formula, idx) => (
            <section key={formula.slug} id={formula.slug} className="mb-12 scroll-mt-20">
              ...
              {/* Source */}
              <div className="bg-[rgba(168,135,64,0.04)] border border-[rgba(168,135,64,0.1)] rounded-lg px-4 py-2 mb-4">
              ...
              <div className="relative w-full aspect-[16/9] rounded-xl overflow-hidden bg-card-bg border border-[rgba(168,135,64,0.12)] mb-6">
                <Image
                  src={formula.image}
                  alt={formula.nameEn}
                  fill
              ...
              <ol className="space-y-2 mb-6">
                {formula.preparationSteps.map((step, i) => (
                  <li key={i} className="flex gap-3 text-sm text-text2 leading-relaxed">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[rgba(168,135,64,0.1)] text-accent font-semibold text-xs flex items-center justify-center">
                      {i + 1}
                    </span>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-6">
                <div className="bg-card-bg rounded-lg border border-[rgba(168,135,64,0.1)] p-4">
          ...
          {/* Quiz CTA */}
          <div className="rounded-2xl bg-gradient-to-br from-[rgba(201,163,85,0.08)] to-[rgba(201,163,85,0.02)] border border-[rgba(168,135,64,0.2)] p-8 text-center mb-12">
          ...
          <div className="space-y-4 mb-12">
            {solution.faqs.map((faq, i) => (
              <div key={i} className="rounded-xl border border-[rgba(168,135,64,0.12)] bg-card-bg p-5">
          ...
          {/* Disclaimer */}
          <div className="rounded-xl bg-[rgba(201,169,110,0.03)] border border-[rgba(201,169,110,0.1)] p-5">
