...
export function drawGradientBg(ctx: CanvasRenderingContext2D, size: PlatformSize) {
  ...
  accent.addColorStop(0, "rgba(140,45,42,0.06)")
  accent.addColorStop(1, "rgba(140,45,42,0)")
...
export function drawGoldBorder(ctx: CanvasRenderingContext2D, size: PlatformSize) {
  ...
  ctx.strokeStyle = "rgba(140,45,42,0.3)"
  ctx.lineWidth = 1
  ctx.strokeRect(inset, inset, W - inset * 2, H - inset * 2)

  ctx.strokeStyle = "rgba(140,45,42,0.65)"
  ctx.lineWidth = 2.5 * s
...
export function drawEmojiGlow(ctx: CanvasRenderingContext2D, x: number, y: number, radius: number) {
  ...
  glow.addColorStop(0, "rgba(140,45,42,0.18)")
  glow.addColorStop(0.5, "rgba(140,45,42,0.06)")
  glow.addColorStop(1, "rgba(140,45,42,0)")
  ctx.fillStyle = glow
...
export function drawGoldDivider(ctx: CanvasRenderingContext2D, y: number, size: PlatformSize) {
  ...
  ctx.strokeStyle = "rgba(140,45,42,0.35)"
  ctx.lineWidth = 1
  ctx.beginPath()
  ctx.moveTo(left, y)
  ...
  ctx.fillStyle = "rgba(140,45,42,0.5)"
...
export function drawFooter(ctx: CanvasRenderingContext2D, size: PlatformSize, code?: string) {
  ...
  if (code && !wide) {
    ...
    ctx.shadowColor = "rgba(140,45,42,0.35)"
    ctx.shadowBlur = 20
...
export function drawBrandHeader(ctx: CanvasRenderingContext2D, size: PlatformSize) {
  ...
  ctx.fillStyle = "rgba(140,45,42,0.7)"
...
export function makeGoldGradient(ctx: CanvasRenderingContext2D, x1: number, x2: number, y: number) {
  ...
  grad.addColorStop(0.5, "#B84A4A")
  grad.addColorStop(1, "#A63A3A")
  return grad
}
