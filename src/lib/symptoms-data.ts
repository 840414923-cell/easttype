...
export const SYMPTOMS: Record<string, SymptomPage> = {
  "why-am-i-always-tired": {
    ...
    ogDesc: "Sleeping well but still exhausted? Chinese medicine says your body type may explain why. Free 5-min assessment included.",
  ...
  "why-do-i-wake-up-at-3am": {
    ...
    metaDesc: "Same time every night? In Chinese medicine, 3AM means something specific. A simple tea may help you sleep through. Free quiz.",
    ogDesc: "3AM wakeups every night? Chinese medicine says your body type may be the reason. Find out which type and what may help.",
  ...
  "why-do-i-have-night-sweats": {
    ...
    ogDesc: "Night sweats but no fever? Chinese medicine says your body type may explain it. Free assessment to find out.",
  ...
  "why-do-i-feel-anxious": {
    ...
    ogDesc: "Anxious but nothing is wrong? Chinese medicine says your body type may explain it. Free assessment to find out.",
