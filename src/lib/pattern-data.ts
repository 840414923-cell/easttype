...
export const PATTERNS: Record<string, PatternPage> = {
  ...
  "natural-balance": {
    ...
    metaTitle: "Natural Balance Pattern — What a Well-Regulated Body Looks Like | EastType",
    metaDesc: "The Natural Balance pattern represents the baseline constitution in Traditional Chinese Medicine. Learn what a balanced body feels like, how to recognize it, and how to protect it from drifting off course.",
